...
const (
	...
	StartedService_SubscribeProxyProviders_FullMethodName        = "/daemon.StartedService/SubscribeProxyProviders"
	StartedService_UpdateProxyProvider_FullMethodName            = "/daemon.StartedService/UpdateProxyProvider"
	StartedService_HealthCheckProxyProvider_FullMethodName       = "/daemon.StartedService/HealthCheckProxyProvider"
	StartedService_SubscribeRuleProviders_FullMethodName         = "/daemon.StartedService/SubscribeRuleProviders"
	StartedService_SubscribeRules_FullMethodName                 = "/daemon.StartedService/SubscribeRules"
	StartedService_UpdateRuleProvider_FullMethodName             = "/daemon.StartedService/UpdateRuleProvider"
...
type StartedServiceClient interface {
	...
	SubscribeProxyProviders(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ProxyProviderList], error)
	UpdateProxyProvider(ctx context.Context, in *ProxyProviderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	HealthCheckProxyProvider(ctx context.Context, in *ProxyProviderHealthCheckRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	SubscribeRuleProviders(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RuleProviderList], error)
	SubscribeRules(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RuleList], error)
	UpdateRuleProvider(ctx context.Context, in *RuleProviderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *startedServiceClient) SubscribeProxyProviders(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ProxyProviderList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[7], StartedService_SubscribeProxyProviders_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[emptypb.Empty, ProxyProviderList]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StartedService_SubscribeProxyProvidersClient = grpc.ServerStreamingClient[ProxyProviderList]

func (c *startedServiceClient) UpdateProxyProvider(ctx context.Context, in *ProxyProviderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, StartedService_UpdateProxyProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *startedServiceClient) HealthCheckProxyProvider(ctx context.Context, in *ProxyProviderHealthCheckRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, StartedService_HealthCheckProxyProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *startedServiceClient) SubscribeRuleProviders(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RuleProviderList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[8], StartedService_SubscribeRuleProviders_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[emptypb.Empty, RuleProviderList]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StartedService_SubscribeRuleProvidersClient = grpc.ServerStreamingClient[RuleProviderList]

func (c *startedServiceClient) SubscribeRules(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RuleList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[9], StartedService_SubscribeRules_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[emptypb.Empty, RuleList]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StartedService_SubscribeRulesClient = grpc.ServerStreamingClient[RuleList]

func (c *startedServiceClient) UpdateRuleProvider(ctx context.Context, in *RuleProviderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, StartedService_UpdateRuleProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *startedServiceClient) StartNetworkQualityTest(ctx context.Context, in *NetworkQualityTestRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[NetworkQualityTestProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[10], StartedService_StartNetworkQualityTest_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) StartSTUNTest(ctx context.Context, in *STUNTestRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[STUNTestProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[11], StartedService_StartSTUNTest_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) SubscribeTailscaleStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TailscaleStatusUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[12], StartedService_SubscribeTailscaleStatus_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) StartTailscalePing(ctx context.Context, in *TailscalePingRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TailscalePingResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[13], StartedService_StartTailscalePing_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) StartTailscaleSSHSession(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TailscaleSSHClientMessage, TailscaleSSHServerMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[14], StartedService_StartTailscaleSSHSession_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) SubscribeTaildropInbox(ctx context.Context, in *SubscribeTaildropInboxRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TaildropInbox], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[15], StartedService_SubscribeTaildropInbox_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) SendTaildropFiles(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TaildropSendClientMessage, TaildropSendServerMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[16], StartedService_SendTaildropFiles_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) DownloadTaildropFile(ctx context.Context, in *DownloadTaildropFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadTaildropFileChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[17], StartedService_DownloadTaildropFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) ProvideUSBDevices(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[USBProviderMessage, USBServerMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[18], StartedService_ProvideUSBDevices_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) SubscribeUSBIPServerStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[USBIPServerStatusUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[19], StartedService_SubscribeUSBIPServerStatus_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) SubscribeOpenConnectStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OpenConnectStatusUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[20], StartedService_SubscribeOpenConnectStatus_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) SubscribeOpenVPNStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OpenVPNStatusUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[21], StartedService_SubscribeOpenVPNStatus_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *startedServiceClient) SubscribeNotifications(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[NotificationEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StartedService_ServiceDesc.Streams[22], StartedService_SubscribeNotifications_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type StartedServiceServer interface {
	...
	SubscribeProxyProviders(*emptypb.Empty, grpc.ServerStreamingServer[ProxyProviderList]) error
	UpdateProxyProvider(context.Context, *ProxyProviderRequest) (*emptypb.Empty, error)
	HealthCheckProxyProvider(context.Context, *ProxyProviderHealthCheckRequest) (*emptypb.Empty, error)
	SubscribeRuleProviders(*emptypb.Empty, grpc.ServerStreamingServer[RuleProviderList]) error
	SubscribeRules(*emptypb.Empty, grpc.ServerStreamingServer[RuleList]) error
	UpdateRuleProvider(context.Context, *RuleProviderRequest) (*emptypb.Empty, error)
...
func (UnimplementedStartedServiceServer) SubscribeProxyProviders(*emptypb.Empty, grpc.ServerStreamingServer[ProxyProviderList]) error {
	return status.Error(codes.Unimplemented, "method SubscribeProxyProviders not implemented")
}
func (UnimplementedStartedServiceServer) UpdateProxyProvider(context.Context, *ProxyProviderRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateProxyProvider not implemented")
}
func (UnimplementedStartedServiceServer) HealthCheckProxyProvider(context.Context, *ProxyProviderHealthCheckRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method HealthCheckProxyProvider not implemented")
}
func (UnimplementedStartedServiceServer) SubscribeRuleProviders(*emptypb.Empty, grpc.ServerStreamingServer[RuleProviderList]) error {
	return status.Error(codes.Unimplemented, "method SubscribeRuleProviders not implemented")
}
func (UnimplementedStartedServiceServer) SubscribeRules(*emptypb.Empty, grpc.ServerStreamingServer[RuleList]) error {
	return status.Error(codes.Unimplemented, "method SubscribeRules not implemented")
}
func (UnimplementedStartedServiceServer) UpdateRuleProvider(context.Context, *RuleProviderRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateRuleProvider not implemented")
}
...
func _StartedService_SubscribeProxyProviders_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(StartedServiceServer).SubscribeProxyProviders(m, &grpc.GenericServerStream[emptypb.Empty, ProxyProviderList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StartedService_SubscribeProxyProvidersServer = grpc.ServerStreamingServer[ProxyProviderList]

func _StartedService_UpdateProxyProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProxyProviderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StartedServiceServer).UpdateProxyProvider(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StartedService_UpdateProxyProvider_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StartedServiceServer).UpdateProxyProvider(ctx, req.(*ProxyProviderRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StartedService_HealthCheckProxyProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProxyProviderHealthCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StartedServiceServer).HealthCheckProxyProvider(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StartedService_HealthCheckProxyProvider_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StartedServiceServer).HealthCheckProxyProvider(ctx, req.(*ProxyProviderHealthCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StartedService_SubscribeRuleProviders_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(StartedServiceServer).SubscribeRuleProviders(m, &grpc.GenericServerStream[emptypb.Empty, RuleProviderList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StartedService_SubscribeRuleProvidersServer = grpc.ServerStreamingServer[RuleProviderList]

func _StartedService_SubscribeRules_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(StartedServiceServer).SubscribeRules(m, &grpc.GenericServerStream[emptypb.Empty, RuleList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StartedService_SubscribeRulesServer = grpc.ServerStreamingServer[RuleList]

func _StartedService_UpdateRuleProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RuleProviderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StartedServiceServer).UpdateRuleProvider(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StartedService_UpdateRuleProvider_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StartedServiceServer).UpdateRuleProvider(ctx, req.(*RuleProviderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StartedService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateProxyProvider",
			Handler:    _StartedService_UpdateProxyProvider_Handler,
		},
		{
			MethodName: "HealthCheckProxyProvider",
			Handler:    _StartedService_HealthCheckProxyProvider_Handler,
		},
		{
			MethodName: "UpdateRuleProvider",
			Handler:    _StartedService_UpdateRuleProvider_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SubscribeProxyProviders",
			Handler:       _StartedService_SubscribeProxyProviders_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "SubscribeRuleProviders",
			Handler:       _StartedService_SubscribeRuleProviders_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "SubscribeRules",
			Handler:       _StartedService_SubscribeRules_Handler,
			ServerStreams: true,
		},
		{
